...
enforcement:
  - "Category must be exactly one of the following fixed enum values: 'Roads & Streets', 'Water & Flooding', 'Sanitation', 'Park Maintenance', 'Public Safety', 'Other'."
  - "Priority must be 'Urgent' if the description explicitly mentions or implies immediate danger, such as keywords: 'injury', 'blood', 'child', 'school', 'trapped', 'fire', 'electrical', or 'collapse'. Otherwise, Priority must be exactly one of: 'High', 'Standard', or 'Low'."
  ...
  - "If the complaint is too vague, ambiguous, or lacks enough detail to confidently assign a category, output category: 'Other', priority: 'Standard', and explain the ambiguity in the 'reason' field (e.g., 'Complaint lacks details to determine the specific issue')."
